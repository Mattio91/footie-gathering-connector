...
import { mockEvents } from './mockEventData';
...
export const mockFields: Field[] = [
  {
    ...
    events: mockEvents.filter(event => event.location.includes('Hackney'))
  },
  {
    id: '2',
    name: 'Regent\'s Park',
    ...
    events: mockEvents.filter(event => event.location.includes('Regent'))
  },
  {
    id: '3',
    name: 'Victoria Park',
    ...
    events: mockEvents.filter(event => event.location.includes('Victoria'))
  },
  {
    id: '4',
    ...
    events: mockEvents.filter(event => event.location.includes('Wormwood'))
  },
];
